...
import com.example.elicop.models.AlimentosDomain;

import java.util.ArrayList;

public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ArrayList<AlimentosDomain> categoryDomains;

    public CategoryAdapter(ArrayList<AlimentosDomain> categoryDomains) {
